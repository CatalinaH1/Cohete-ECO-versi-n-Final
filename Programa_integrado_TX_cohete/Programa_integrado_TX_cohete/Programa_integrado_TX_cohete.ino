...
void loop()
{
  ...
  radio.write(datos, sizeof(datos)); // Envia los datos almancenados en la variable datos a traves del objeto radio. El tamaño de los datos se determina utilizando la función "sizeof(datos)"
    ...
    Serial.print(ALTITUD); // Imprime los valores de altitud a traves del puerto serial
    Serial.print(",");
    Serial.print(AcX); // Imprime los valores de Aceleración en X a traves del puerto serial
    Serial.print(",");
    Serial.print(AcY); // Imprime los valores de Aceleración en Y a traves del puerto serial
    Serial.print(",");
    Serial.print(AcZ); // Imprime los valores de Aceleración en Z a traves del puerto serial
    Serial.print(",");
    Serial.print(GyX); // Imprime los valores de Giroscopio en X a traves del puerto serial
    Serial.print(",");
    Serial.print(GyY); // Imprime los valores de Giroscopio en X a traves del puerto serial
    Serial.print(",");
    Serial.print(GyZ); // Imprime los valores de Giroscopio en X a traves del puerto serial
    Serial.print(",");
